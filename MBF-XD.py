...
def jalankan_tool():
    os.system('MBF-XD.py' if os.name == 'nt' else 'python2 MBF-XD.py')
    ...
    try:
        ...
        with requests.Session() as (ses_dev):
            ...
            if 'c_user' in login_dev:
                ...
                __token__dev(cookie)
                token = open('token.txt', 'r').read()
                print h + '\n [!]' + p + ' Jalankan lagi Toolsnya' + h + '..!\n Ketik Perintah ' + k + 'python2 MBF-XD.py\n' + p
                exit()
...
def login():
    ...
    try:
        ...
        admin = k + '\n [>.] Silahkan Hubungi Admin! \n' + h + '     No Whatsapp Admin =>' + p + ' 089690560542'
        try:
            if user_agent_ == cokiez:
                if pilih == '6':
                    print garis
...
def __menu__(token):
				...
				if user_agent_ == cokiez: 
					...
					if "|" in user_agentzz_:
						...
						if ":" in str(lim_dev) or "-" in str(lim_dev):
							...
							print p+" [>] Ini No WA Admin:"+p+" 6289690560542"
							try:
 ...
 """+a+""" No DANA >>"""+k+""" 083160238661
 """+a+""" No OVO >> """+k+"""083160238661\n
  """+p+"""list harga:
  ------------
    """+k+""">"""+p+""" 1 Bulan 50k
    """+k+""">"""+p+""" Permanen 150k\n"""
